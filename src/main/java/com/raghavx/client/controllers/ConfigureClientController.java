...
public class ConfigureClientController {
	private static final Logger logger = LoggerFactory.getLogger(ConfigureClientController.class);
	...
	public void test() {
		...
		try {
			...
			// demo of a "synchronous" enquireLink call - send it and wait for a
			// response
